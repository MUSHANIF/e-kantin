...
<form action="{{ url('superadmin/condiment') }}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
        <label for="formGroupExampleInput">Condiment ID</label>
        <input type="text" class="form-control" id="ProdID" name="CondID" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <img id="preview-image-before-upload" src="" alt="" style="width: 150px" class="img-fluid">
    </div>
