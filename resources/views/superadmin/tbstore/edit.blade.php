...
<div class="container">
    ...
    <form method="POST" action="{{ url('superadmin/store/' .$store->id) }}" enctype="multipart/form-data" >
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="formGroupExampleInput" name="Location" value="{{ $store->Location }}">
        </div>
        <div class="form-group">
            <label for="formGroupExampleInput2">QR Code</label>
            <input type="text" class="form-control" id="formGroupExampleInput2" name="QrCode" value="{{ $store->QrCode }}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="formGroupExampleInput2" name="active" value="{{ $store->active }}">
        </div>
          <div class="form-group">
