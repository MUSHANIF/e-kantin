...
@section("button")
<a href="store/create" class="d-none d-sm-inline-block btn btn-sm text-white  shadow-sm" style="background-color: #ff9106;"><i class="fas fa-download fa-sm text-white"></i>Tambah</a>
@endsection
@section('isi')
<div class="container">
        ...
        <tbody>
            <tr class="align-self-center" style="border: 1px solid black;">
                ...
                <td class="text-center justify-content-center align-self-center d-flex">
                    ...
                    <a class="btn btn-info" href="{{ url('manager/store/'.$key->id.'/edit') }}">Ubah</a>
                    <form action="{{ url('manager/store/'.$key->id) }}" method="POST" ">
                        @csrf
